...
return array(
    ...
    //各场景对应的安全转义函数，正则配置
    'escape_js' 				=> '/fis_js_escape|f_escape_js|escape:javascript/',	//js转义函数配置
    'escape_html' 				=> '/fis_html_escape|f_escape_xml|escape:html|escape/',		//html转义函数配置
    'escape_event' 				=> '/fis_event_escape|f_escape_event/',					//标签事件属性值场景转义函数配置
    'escape_data' 				=> '/f_escape_data/',					//json数据转义配置
    'escape_path' 				=> '/f_escape_path|f_escape_path|escape:url/',				//url属性里转义
    ...
    'XSS_SAFE_VAR' 			=> array('/fis_safe/','/fis_xss/',),								//安全变量列表，必须是正则，不包含$
